...
public class AuditEventInterceptor {
  ...
  public void createAuditEventResourceFromCreate (
    ...
    throws IOException{
    System.out.println(theNewResource.getClass() != AuditEvent.class);
  ...
  private AuditEvent.AuditEventAction buildAuditEventAction(String theRequestTypeString){
    ...
    if (Objects.equals(theRequestTypeString, "POST")) {
      return AuditEventAction.C;
    } else if (Objects.equals(theRequestTypeString, "GET")){
      return AuditEventAction.R;
    } else if (Objects.equals(theRequestTypeString, "PUT")){
      return AuditEventAction.U;
    } else if (Objects.equals(theRequestTypeString, "PATCH")){
      return AuditEventAction.U;
    } else if (Objects.equals(theRequestTypeString, "DELETE")){
      return AuditEventAction.D;
    } else if (Objects.equals(theRequestTypeString, "SEARCH")){
  ...
  private AuditEventEntityComponent buildAuditEventEntityComponent(
    ...
    List<String> snapshotMethods = new ArrayList<>( List.of("POST", "PUT", "PATCH"));
